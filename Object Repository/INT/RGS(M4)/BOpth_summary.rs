...
<WebServiceRequestEntity>
   ...
   <name>BOpth_summary</name>
   <tag></tag>
   <elementGuidId>d06ecf27-7eb0-4d5c-9b6f-a9a8a0e135f8</elementGuidId>
   ...
   <variables>
      <defaultValue>findTestData('INT_data').getValue(7, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('INT_data').getValue(8, 1)</defaultValue>
      <description></description>
...
def bo_totalCount = result_boquery.documents.query.totalCount
GlobalVariable.bo_totalCount = bo_totalCount
