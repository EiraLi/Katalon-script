...
M4_init = WS.sendRequestAndVerify(findTestObject('STG/RGS(M4)/M4_init', [('partner') : Partner, ('gameId') : gameId, ('M4_login_user_id') : GlobalVariable.M4_login_user_id]))
...
WS.sendRequestAndVerify(findTestObject('STG/RGS(M4)/Summary_history', [('partner_code') : partner_code, ('game_code') : Game_code
...
WS.callTestCase(findTestCase('STG_env/compare_values/7_summary_page_baseSpin_verify_value'), [('Partner') : Partner
