...
WS.sendRequestAndVerify(findTestObject('INT/RGS(M4)/in_game_history_BaseSpin', [('partner') : Partner, ('M4_spin_transaction_id') : GlobalVariable.M4_spin_transaction_id
            , ('M4_login_user_id') : GlobalVariable.M4_login_user_id]))
...
WS.sendRequestAndVerify(findTestObject('INT/RGS(M4)/BOpth_summary', [('url_krug') : url_krug, ('userid') : Userid, ('start_date') :start_date, ('end_date') : end_date, ('partner') : Partner]))
//def bo_payload  = GlobalVariable.bo_payload
//
//def counter = 0
//for (int i = 0; i < bo_payload.size(); i++){
//	def bo_txType = bo_payload[i].txType
//	if (bo_txType == "SPIN") {
//		counter = counter + 1
//	}
//}
